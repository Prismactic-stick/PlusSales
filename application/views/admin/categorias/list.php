        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    class="btn btn-primary btn-flat"><span class="fa fa-plus"></span> Agregar Categoria</a>
                </div>
            </div>
            <hr>
            <div class="row">
                                ...
                                <?php foreach($categorias as $categoria):?>
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <!-- ICONO VER -->
                                         <button type="button" class="btn btn-success btn-view" data-toggle="modal" data-target="#modal-default" 
